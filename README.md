...
DeepSeek requests use Chat Completions with thinking explicitly disabled to keep the interactive result fast while retaining the selected model's final-answer quality.
